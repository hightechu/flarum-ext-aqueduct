  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'sidebarItems', function (items) {
    ...
    tags.forEach(function (tag) {
      controls.add('board-' + tag.slug(), flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
        children: app.translator.trans('aqueduct.forum.discussion.buttons.show-board', {
          tag: tag.name()
        }),
        icon: 'fab fa-trello',
        onclick: function onclick() {
          return m.route(app.route('aqueduct.board', {
            tag: tag.slug()
          }));
        }
      }));
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'sidebarItems', function (items) {
    ...
    if (tag && (tag.canAccessBoard() || tag.canUseBoard() || tag.canManageBoard())) {
      items.add('board', flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m('div', {
    ...
    }, m('h4', [tag.name(), m('span', tag.description()), this.controls().isEmpty() ? [] : flarum_components_SplitDropdown__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      ...
      slug: tag.slug()
    }, this.loading || this.discussions.length == 0 ? '' : this.discussions.map(function (discussion) {
...
/* harmony import */ var _addsBoardToIndex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addsBoardToIndex */ "./src/forum/addsBoardToIndex.js");
...
app.initializers.add('hyn-aqueduct', function (app) {
  flarum_tags_models_Tag__WEBPACK_IMPORTED_MODULE_4___default.a.prototype.canAccessBoard = flarum_Model__WEBPACK_IMPORTED_MODULE_3___default.a.attribute('canAccessBoard');
  ...
  flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_5___default.a.prototype.canAccessBoard = flarum_Model__WEBPACK_IMPORTED_MODULE_3___default.a.attribute('canAccessBoard');
  flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_5___default.a.prototype.canUseBoard = flarum_Model__WEBPACK_IMPORTED_MODULE_3___default.a.attribute('canUseBoard');
  ...
  Object(_addsBoardToIndex__WEBPACK_IMPORTED_MODULE_2__["default"])();
});
...
/* harmony import */ var _modals_AddColumnModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../modals/AddColumnModal */ "./src/forum/modals/AddColumnModal.js");
/* harmony import */ var _components_Card__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/Card */ "./src/forum/components/Card.js");
/* harmony import */ var _components_Column__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/Column */ "./src/forum/components/Column.js");
  ...
  _proto.controls = function controls() {
    ...
    if (tag.canManageBoard()) {
      ...
      if (this.draggable === 'cards') {
        items.add('drag-columns', flarum_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
